...
st.sidebar.warning('⚠️ This is a prototype and is known to breakdown after certain number of tries, please reboot the app or contact the developer', color='red')
